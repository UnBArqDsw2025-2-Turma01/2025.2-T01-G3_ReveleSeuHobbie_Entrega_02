...
O Diagrama de Atividades é uma das ferramentas da UML (Linguagem de Modelagem Unificada) usada para representar os fluxos de trabalho de um sistema. Pense nele como um fluxograma avançado que mostra o fluxo de controle de uma atividade para outra. [[1]](#referência-bibliográfica)
...
A criação dos Diagramas de Atividades para esta documentação seguiu um processo estruturado para garantir que esteja dentro do escopo de entrega mínima e com a intenção de seguir a notação UML. A criação consistiu na análise dos vídeos postados na plataforma do `aprender` [[2]](#referência-bibliográfica) e também os slides apresentados em sala de aula.
...
1. **Definição do Escopo e Objetivo**: Antes de iniciar a modelagem, foram decididas quais atividades seriam mapeadas, estabelecendo assim o escopo do diagrama (no caso decidimos 4 atividades principais que compõem a aplicação), identificando o ponto de início (Nó Inicial) e os possíveis pontos de término (Nó Final) das seguintes atividades:
  ...
  - `Registrar Hobbie`
2. **Ferramenta de Modelagem**: Como utilizada em entregas passadas, decidimos utilizar o [Lucidchart](https://www.lucidchart.com/pages), pois já havíamos feito um BPMN anteriormente e reaproveitamos o template 
...
2. O sistema oferece duas maneiras paralelas (Fork) para a descoberta:
    - Caminho A: Recomendação do Sistema: O usuário recebe sugestões baseadas em seu perfil e pode optar por ver "Comunidades com hobbies semelhantes" ou "Comunidades mais destacadas".
...
1. LUCIDCHART. O que é diagrama de atividades UML?. 2025. Disponível em: [Lucidchart](https://www.lucidchart.com/pages/pt/o-que-e-diagrama-de-atividades-uml). Acesso em: 21 set. 2025.  
2. SERRANO, Milene. AULA - MODELAGEM UML ESTÁTICA. [S. l.]. 2025. Disponível em: [Aprender3](https://aprender3.unb.br/pluginfile.php/3178387/mod_page/content/1/Arquitetura%20e%20Desenho%20de%20Software%20-%20Aula%20Modelagem%20UML%20Est%C3%A1tica%20-%20Profa.%20Milene.pdf). Acesso em: 21 set. 2025.

## Histórico de Versões

| Versão | Data       | Descrição                       | Autor(es)               | Revisor(es)          | Comentários | Data de Revisão |
|--------|------------|---------------------------------|------------------------|----------------------|-----------------|-----------------|
| `1.0`  | 16/09/2025 | Criação do documento e adicionando novos conteúdos dos diagramas de atividades           | [Paulo Lamounier](https://github.com/Nanashii76) e [Natan Almeida](https://github.com/natanalmeida03)   | N/A | N/A  | N/A  |
| `1.1`| 21/09/2025 | Adicionando metodologia na documentação | [Paulo Lamounier](https://github.com/Nanashii76)  |    [Ana Luiza Soares](https://github.com/Ana-Luiza-SC)    |  Foi corrigido o side bar e o histórico de versionamento | 21/09/2025 |
| `1.2`| 21/09/2025 | Adicionando referência bibliográfica e corrigindo metodologia na documentação | [Paulo Lamounier](https://github.com/Nanashii76)  |        |   |  |