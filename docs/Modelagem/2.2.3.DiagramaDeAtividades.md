...
A criação dos Diagramas de Atividades para esta documentação seguiu um processo estruturado para garantir que esteja dentro do escopo de entrega mínima e com a intenção de seguir a notação UML. A criação consistiu na análise dos vídeos postados na plataforma do `aprender` e também os slides apresentados em sala de aula.
