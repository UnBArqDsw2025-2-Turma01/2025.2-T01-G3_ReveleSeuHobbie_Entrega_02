...
|------------|--------|--------------------------------|-----------------------------------|----------------------------|---------------------------|------------------|
| `1.0` | 22/09/2025 | Criação do documento com seções de Introdução, Metodologia e Especificação dos Casos de Uso: UC25 a UC32. | [Matheus de Alcântara](https://github.com/matheusdealcantara) |  [Ana Luiza](https://github.com/Ana-Luiza-SC) | Aprovado | 22/09/2025 |